...
public class AutomationScriptRunner extends AutomationScripts{
	...
	public static void main(String[] args) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, IOException {
		...
		String[][] recData = AutomationScripts.readExcel("C:\\Users\\vj\\Desktop\\Amazon.com\\test execution controller.xlsx", "Sheet1");
		cur_dt = new Date(); 
		DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
		String strTimeStamp = dateFormat.format(cur_dt);
		writeExecutionResults(recData[0][1], strTimeStamp, "C:\\Users\\vj\\Desktop\\amazon.com\\test execution controller.xlsx", "Sheet1", "");
